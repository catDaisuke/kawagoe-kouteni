    ...
    <b-row>
        ...
        <b-col sm="8">
            <div>
                ...
                <b-form-input id="inputFirstName" v-model="user.memberFirstName"></b-form-input>
                </b-form-group>
                <b-form-group id="lastName"
                    ...
                    <b-form-input id="inputLastName" v-model="user.memberLastName"></b-form-input>
                </b-form-group>
                <b-form-group id="nickName"
                    ...
                    <b-form-input id="inputNickName" v-model="user.memberNickName"></b-form-input>
                </b-form-group>
                <b-form-group id="email"
                    ...
                    <b-form-input id="inputEmail" type="email" v-model="user.memberMailAddress"></b-form-input>
                </b-form-group>
            </div>
            <b-button v-on:click="change">変更</b-button>
        </b-col>
         <b-col sm="2">
        </b-col>
    </b-row>
